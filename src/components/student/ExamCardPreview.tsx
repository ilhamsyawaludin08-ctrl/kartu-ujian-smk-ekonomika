      ...
      <div className="p-4 md:p-8 print:p-0 w-full flex justify-center overflow-x-auto">
        ...
        <div id="print-wrapper" className="print:w-[210mm] print:h-[148mm] print:overflow-hidden relative mx-auto shrink-0">
          ...
          >
            ...
            <div className="absolute inset-0 border-2 md:border-[6px] border-gray-900 pointer-events-none z-50 rounded-lg" />
          ...
          <div className="flex justify-between items-start mb-3 md:mb-4 gap-4">
            ...
            {data.examSettings.show_photo && (
              <div className={`w-[2.5cm] h-[3.5cm] md:w-[4.5cm] md:h-[6cm] border-2 border-gray-800 p-1 flex-shrink-0 bg-gray-50 shadow-sm relative ${isVeryCompact ? 'hidden print:block print:w-[2.5cm] print:h-[3.5cm] md:print:w-[4.5cm] md:print:h-[6cm]' : ''}`}>
          ...
          <div className="mt-2 md:mt-4 flex justify-between items-end text-xs md:text-sm pt-1 print:break-inside-avoid">
            ...
            <div className="w-56 md:w-72 text-center flex flex-col items-center flex-shrink-0">
              ...
              <div className="h-20 md:h-40 flex items-center justify-center mb-1 w-full">
